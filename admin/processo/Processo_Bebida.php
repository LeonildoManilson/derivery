...
if(empty($_POST['nome'])){
    ...
    $url = 'http://localhost/Programa%C3%A7ao%20Web/admin/Registar-Bebida.php';
    echo "
...
if(empty($_POST['preco'])){
    $_SESSION['value_Bebida'] = "campo preco é obrigatório";
    $url = 'http://localhost/Programa%C3%A7ao%20Web/admin/Registar-Bebida.php';
    echo "
        <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=$url'>
    ";
...
echo "
        <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/Programa%C3%A7ao%20Web/admin/Registar-Bebida.php'>
...
if (move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'] . $nome_final)) {
    ...
    if($cat->insert()){
        echo "
        <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/Programa%C3%A7ao%20Web/admin/Listar_Bebida.php'>
        <script type=\"text/javascript\">
            alert(\"Bebida registado com sucesso.\");
        </script>
        ";
        unset($_SESSION['value_Bebida']);
        unset($_SESSION['vazio_nome_Bl']);
        unset($_SESSION['vazio_descricao_Bl']);
