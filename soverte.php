...
<section class="Popular" id="Popular">
    ...
    <h1 class="heading">Sovertes <span>Mais</span>  Populares </h1>

    <div class="box-container">
    <?php foreach ($cat->listarSoverte() as $key => $value):?>

        <div class="box">
            <span class="price"> <?php echo number_format($value->preco,'2',',','.');?></span>
